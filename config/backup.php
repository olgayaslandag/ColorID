...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 *
                 * We include only the public disk (storage/app/public) and the database.
                 * The database is backed up separately via the 'databases' configuration below.
                 */
                'include' => [
        ...
        'destination' => [
             ...
             *
             * Defaults to the application's primary filesystem disk (configured via
             * FILESYSTEM_DISK env var). In production this is typically 's3' or 'r2'
             * for off-site redundant storage; locally it defaults to 'public'.
             */
            'disks' => [
    ...
    'monitor_backups' => [
        [
            'name' => env('APP_NAME', 'laravel-backup'),
            'disks' => [env('FILESYSTEM_DISK', 'public')],
            'health_checks' => [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             * Configured to keep all backups for the most recent 7 days.
             */
             ...
             *
             * Set to 0 since our daily retention is handled by keep_all_backups_for_days.
             */
            'keep_daily_backups_for_days' => 0,

            /*
             * After the daily retention period, the most recent backup of each week
             * will be kept for the specified number of weeks.
             * Configured to keep 4 weekly backups.
             */
            'keep_weekly_backups_for_weeks' => 4,

            /*
             * After the weekly retention period, the most recent backup of each month
             * will be kept for the specified number of months.
             * Configured to keep 3 monthly backups.
             */
            'keep_monthly_backups_for_months' => 3,

            /*
             * After the monthly retention period, the most recent backup of each year
             * will be kept for the specified number of years.
             * Set to 0 to disable yearly retention (not required by current policy).
             */
